<?php
	...
	$breadcrumb[2]['title'] = 'Lihat User Level';
	$breadcrumb[2]['url'] = url('backend/users-level/'.$data[0]->id);
?>
					...
					<div class="box box-info">
						<div class="container-fluid mb-5">
							<div class="box-header with-border">
								<center><h3>Lihat USer Level</h3></center>
							</div>
							...
							?>
								<div class="box-body">
									...
									<div class="form-group">
										...
										<label for="inputNIK" class="col-sm-3 col-xs-3 control-label">Level</label>
