<?php
	...
	$breadcrumb[1]['title'] = 'Penduduk Meninggal';
	$breadcrumb[1]['url'] = url('backend/meninggal');
	$breadcrumb[2]['title'] = 'Tambah';
	$breadcrumb[2]['url'] = url('backend/meninggal/tambah');
	if (isset($data)){
		$breadcrumb[2]['title'] = 'Ubah';
		$breadcrumb[2]['url'] = url('backend/meninggal/'.$data[0]->id.'/edit');
	}
?>
...
@section('content')
    <?php
		...
		if (isset($data)){
			...
			$method = "PUT";
			$mode = "Ubah";
			$url = "backend/meninggal/".$data[0]->id;
		}
	?>
					...
					<div class="box box-info">
						<div class="container-fluid mb-5">
							<div class="box-header with-border">
								<center><h3><?=$mode;?> Data Penduduk Meninggal</h3></center>
							</div>
							<br><br>
							...
							{{ Form::open(['url' => $url, 'method' => $method, 'class' => 'form-horizontal']) }}
								...
								<div class="box-body">
									...
									<div class="form-group">
										<label for="inputTanggal" class="col-sm-4 col-xs-4 control-label">Tanggal Meninggal</label>
										<div class="col-sm-6 col-xs-8">
